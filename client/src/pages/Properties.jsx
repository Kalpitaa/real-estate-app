...
import { FaSearch, FaFilter, FaMapMarkerAlt, FaHome, FaBuilding, FaTrophy } from 'react-icons/fa';
...
const Properties = () => {
  ...
  return (
    <div className="pt-20 bg-gray-50 dark:bg-gray-900">
      ...
      {/* Floating Filter Bar */}
      <section className="sticky top-20 z-40 -mt-8">
          ...
          >
            <div className="flex flex-col lg:flex-row justify-between gap-4 items-center">
              ...
              <button
                ...
                className="lg:hidden flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-100 dark:bg-gray-700"
              >
                <FaFilter />
                <span>Filters</span>
              </button>
          ...
          {filteredProperties.length > 0 ? (
            ...
            >
              ...
              <button
                ...
                className="mt-6 px-6 py-2 bg-blue-600 text-white rounded-xl font-medium hover:shadow-lg transition-shadow"
              >
                Reset Filters
              </button>
            </motion.div>
      ...
      <section className="py-16 bg-white dark:bg-gray-800 mt-8 border-y border-gray-100 dark:border-gray-700">
